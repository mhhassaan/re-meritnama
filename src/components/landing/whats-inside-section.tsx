        ...
        {ITEMS.map((item, idx) => (
          ...
          >
            <div className="flex flex-col items-center text-center w-full">
              ...
              {/* Title */}
              <h3 className="font-sans text-2xl font-extrabold text-brand-ink tracking-tight mb-2 group-hover:text-brand-teal transition-colors duration-200">
                {item.title}
              </h3>
            ...
            <div className="pt-6 mt-4 border-t border-stone-200/50 group-hover:border-stone-300/80 transition-colors w-full text-center">
              <span className="font-mono text-[10px] font-bold tracking-[0.28em] text-stone-400 uppercase group-hover:text-brand-teal transition-colors">
                {item.eyebrow}
              </span>
            </div>
          </Link>
